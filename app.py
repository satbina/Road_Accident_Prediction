...
# predict the target from all the input features
       ...
       st.write("Developed By: Satya Bikash Nayak")
       st.markdown("""Reach out to me on: [Twitter](https://twitter.com/SatyaBikash1) |
       [Linkedin](https://www.linkedin.com/in/satya-bikash-nayak-5200a9200/)
       """)
